...
(function(){
	...
	// private functions
	useful.Slideshow_Figures = function (parent) {
		this.root = parent;
		this.parent = parent;
		// build the figures
		this.setup = function () {
		...
		this.menu = new useful.Slideshow_Figures_Menu(this);
	};

	// return as a require.js module
	if (typeof module !== 'undefined') {
		exports = module.exports = useful.Slideshow_Figures;
	}
...
(function(){
	...
	// private functions
	useful.Slideshow_Thumbnails = function (parent) {
		this.root = parent;
		this.parent = parent;
		...
		this.menu = new useful.Slideshow_Thumbnails_Menu(this);
	};

	// return as a require.js module
	if (typeof module !== 'undefined') {
		exports = module.exports = useful.Slideshow_Thumbnails;
	}
